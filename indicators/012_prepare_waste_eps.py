"""
012_prepare_Waste_eps.py — EPS Value Factor script: waste

Waste littering to ground and water

Pipeline
────────
  Stage 1  Configuration  config.get_indicator_config("waste")
...
Outputs
───────
  output/012_eps_waste.h5     HDF5: keys "coefficient" and "unit"
  output/012_eps_waste.xlsx   Excel: sheets "Coefficients", "Units", "Pathway data"

"""
003_prepare_Voc_eps.py — EPS Value Factor script: voc

Volatile organic compound emissions to air (alkanes, aromatics, …)

Pipeline
────────
  Stage 1  Configuration  config.get_indicator_config("voc")
...
Outputs
───────
  output/003_eps_voc.h5     HDF5: keys "coefficient" and "unit"
  output/003_eps_voc.xlsx   Excel: sheets "Coefficients", "Units", "Pathway data"
